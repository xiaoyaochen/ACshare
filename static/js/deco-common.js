...
function search_click(){
    ...
    if(type == "videos"){
        request_url = "/videos/search?keywords="+keywords
    }else if(type == "up_mans"){
        request_url = "/users/search?keywords="+keywords
    }else if(type == "posts"){
        request_url = "/forums/forums_list?keywords="+keywords
    }
