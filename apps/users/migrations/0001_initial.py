# Generated by Django 2.0 on 2019-03-14 17:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, max_length=200, null=True, upload_to='users/%y/%m/%d', verbose_name='用户头像')),
                ('birthday', models.DateTimeField(blank=True, null=True, verbose_name='用户生日')),
                ('gender', models.CharField(choices=[('M', '男'), ('F', '女')], default='M', max_length=16, verbose_name='用户性别')),
